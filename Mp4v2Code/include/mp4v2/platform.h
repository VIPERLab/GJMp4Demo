...
// Music Manager custom change
// We're using the DLL CRT, which sets _WINDLL, but not compiling this library as a DLL.
#if defined ( _WIN32 ) && defined ( MP4V2_EXPORT )
#undef MP4V2_EXPORT
#define MP4V2_EXPORT
#endif
// End Music Manager custom change
